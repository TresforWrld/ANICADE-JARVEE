...
window.ASSISTANT_CONFIG = {
  ...
  selfSpeechCooldownMs: 1100,
  ttsNetworkTimeoutMs: 1400,
  ttsRate: 1.05,
  ttsPitch: 0.92,
  ttsVolume: 1,
  speechChunkMaxChars: 360,
  showCaptions: false,
  ...
  // Cloud sync (not wired in app.js yet — local follow-up memory uses localStorage)
  JSONBIN_BIN_ID: '',
  JSONBIN_MASTER_KEY: '',
  JSONBIN_ACCESS_KEY: '',

  shortSpeechCooldownMs: 380,
  // Optional: set preferElevenLabs: true when ELEVENLABS_* keys are filled
